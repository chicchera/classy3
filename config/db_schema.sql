...
CREATE INDEX "posts_dfrid_IDX" ON "posts" ("dfrid_post");
CREATE INDEX "posts_id_user_IDX" ON "posts" ("id_user");
CREATE INDEX "posts_rid_post_IDX" ON "posts" ("rid_post");
CREATE INDEX "posts_date_posted_IDX" ON "posts" ("date_posted");
